<div class="col-md-7">
			<div class="breadcrumb-wrapper"><ol class="breadcrumb">
			  ...
			  <li><a href="<?php echo base_url() . 'home/category/' . $idea->categoryid . "/" . str_replace(" ", "-", $all_categories[$idea->categoryid]->name); ?>"><?php echo $categories[$idea->categoryid]->name;?></a></li>
